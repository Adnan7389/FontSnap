    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 shadow-lg border border-gray-200 mb-8">
        <div className="text-center mb-4">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Image Cropping Tool</h3>
          <p className="text-gray-600 text-sm">Select the text area by dragging and resizing the crop box</p>
        </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">Crop Controls</h3>
        <div className="flex flex-wrap gap-4 justify-center">
          <button
            onClick={() => handleRotate(-90)}
            disabled={!isReady}
            className="flex items-center space-x-3 px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 rounded-xl transition-all duration-300 font-medium border border-gray-300 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <MdRotateLeft className="text-gray-600 text-xl" />
          ...
          <button
            ...
            className="flex items-center space-x-3 px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 rounded-xl transition-all duration-300 font-medium border border-gray-300 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <MdRotateRight className="text-gray-600 text-xl" />
          ...
          <button
            ...
            className="flex items-center space-x-3 px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 rounded-xl transition-all duration-300 font-medium border border-gray-300 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <MdOutlineZoomOutMap className="text-gray-600 text-xl" />
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6 mb-8">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-blue-900 mb-3">How to Crop Your Image</h3>
            <div className="grid md:grid-cols-2 gap-3 text-sm text-blue-800">
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs">1</div>
                <span>Drag to create a selection around the text</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs">2</div>
                <span>Resize the selection by dragging the corners</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs">3</div>
                <span>Move the selection by dragging the center</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs">4</div>
      ...
      <div className="mt-8 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6">
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h4 className="text-lg font-semibold text-green-900 mb-2">For Best Results</h4>
