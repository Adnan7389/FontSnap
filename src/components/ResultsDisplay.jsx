...
function ResultsDisplay({ extractedText, croppedImage, fontMatches }) {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      {/* Original comparison */}
      <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg border border-gray-200 mb-12">
        <div className="flex items-center space-x-3 mb-6">
          <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center">
            <MdOutlineCompare className="text-blue-600 text-xl" />
          </div>
          <div>
            <h3 className="text-2xl font-semibold text-gray-900">Text Analysis</h3>
            <p className="text-gray-600">Original image vs extracted text comparison</p>
          </div>
        </div>

        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-xl p-6 shadow-inner border border-gray-300">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200">
            ...
            <div className="bg-white/80 rounded-lg p-6 border-2 border-blue-200">
              <p className="text-2xl font-semibold text-blue-900 text-center leading-relaxed">
                "{extractedText}"
              </p>
            </div>
          </div>
      ...
      <div className="mb-12">
        <div className="flex items-center space-x-3 mb-8">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-gray-900">Top Font Matches</h3>
            <p className="text-gray-600">Ranked by similarity score</p>
          </div>
        </div>

        <div className="space-y-8">
          {fontMatches.map((match, index) => (
            <div key={match.name} className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                      <h4 className="text-2xl font-bold text-gray-900">{match.name}</h4>
                      <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium">
                        Weight: {match.weight}
                      </span>
                    </div>
                    <p className="text-gray-600">Family: {match.family}</p>
                  </div>
                </div>
              ...
              {/* Font preview */}
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 mb-6 border border-gray-300">
                <h5 className="text-lg font-semibold text-gray-900 mb-4">Font Preview</h5>
                <div className="bg-white rounded-lg p-6 border-2 border-gray-200 shadow-inner">
                  {match.previewCanvas && (
                    <img
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                <button
                  ...
                  className="flex items-center space-x-3 px-6 py-3 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-xl transition-all duration-300 font-semibold border border-blue-200 hover:shadow-md"
                >
                ...
                <a
                  ...
                  className="flex items-center space-x-3 px-6 py-3 bg-green-50 hover:bg-green-100 text-green-700 rounded-xl transition-all duration-300 font-semibold border border-green-200 hover:shadow-md"
                >
                ...
                {match.previewCanvas && (
                  <button
                    ...
                    className="flex items-center space-x-3 px-6 py-3 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-xl transition-all duration-300 font-semibold border border-gray-300 hover:shadow-md"
                  >
      ...
      {fontMatches.length === 0 && (
        <div className="text-center py-16 bg-white rounded-2xl shadow-lg border border-gray-200">
          ...
          <h3 className="text-2xl font-semibold text-gray-900 mb-3">No Font Matches Found</h3>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8">
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            <h4 className="text-xl font-semibold text-blue-900 mb-4">Tips for Better Font Identification</h4>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 text-blue-800">
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs mt-0.5">1</div>
                <span>Use high-resolution images</span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs mt-0.5">2</div>
                <span>Ensure good text-background contrast</span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs mt-0.5">3</div>
                <span>Crop tightly around the text</span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs mt-0.5">4</div>
                <span>Include multiple characters</span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs mt-0.5">5</div>
                <span>Avoid blurry or pixelated text</span>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-semibold text-xs mt-0.5">6</div>
